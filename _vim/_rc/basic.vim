...
fun! <SID>StripTrailingWhitespaces()
    ...
    call cursor(l, c)
endfun
autocmd BufEnter FileType c,cpp,java,go,php autocmd BufWritePre <buffer> :call <SID>StripTrailingWhitespaces()
autocmd BufEnter FileType javascript,puppet autocmd BufWritePre <buffer> :call <SID>StripTrailingWhitespaces()
autocmd BufEnter FileType python,rust,twig autocmd BufWritePre <buffer> :call <SID>StripTrailingWhitespaces()
autocmd BufEnter FileType xml,yml,perl autocmd BufWritePre <buffer> :call <SID>StripTrailingWhitespaces()
